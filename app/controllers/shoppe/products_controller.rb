module Shoppe
  class ProductsController < Shoppe::ApplicationController
    ...
    def safe_params
      params[:product].permit(:product_category_id, :name, :sku, :permalink, :description, :short_description, :weight, :colors, :sizes, :price, :cost_price, :tax_rate_id, :stock_control, :default_image_file, :data_sheet_file, :active, :featured, :in_the_box, :product_attributes_array => [:key, :value, :searchable, :public])
    end
